    ...
    public class MasomoBoostDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> IntroStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            await stepContext.Context.SendActivityAsync(
                MessageFactory.Text("Ngao Credit offers quick loans to boost your college/university education with an interest rate as low as 3.5%.  You can borrow up this type of loan within in 6 hrs and repay within a period of up to 24 months." +
